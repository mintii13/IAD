...
def run_training(test_mode=None):
    ...
    cmd_args = [
        'python', '-W', 'ignore::requests.RequestsDependencyWarning', 'main.py',
        '--gpu', str(config['gpu']),
    ...
    env = os.environ.copy()
    env['PYTHONWARNINGS'] = 'ignore::requests.RequestsDependencyWarning'
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if test_mode in ['ckpt', 'test']:
            ...
            print("Usage: python mpdd_config_fixed.py [ckpt|test]")
