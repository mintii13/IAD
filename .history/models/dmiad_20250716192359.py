...
class DMIAD(nn.Module):
    ...
    def _build_memory_modules(self, config):
        ...
        print('FEATURE DIM, TEM_DIM, SHRINK')
        print(self.feature_dim)
        print(config.MODEL.MEMORY.TEMPORAL_DIM)
        print(config.MODEL.MEMORY.SHRINK_THRES)
        ...
        if self.use_spatial_memory:
            ...
            print('SPA DIM, SHRINK, H, W')
            print(config.MODEL.MEMORY.SPATIAL_DIM)
            print(config.MODEL.MEMORY.SHRINK_THRES)
            print(self.spatial_h)
            print(self.spatial_w)
